...
/******/ 	var hotCurrentHash = "507fc1904377dd1675a4"; // eslint-disable-line no-unused-vars
	...
	var Slider = function () {
		...
		_createClass(Slider, [{
			...
			value: function init() {
				...
				[].forEach.call(this.slides, function (slide, index) {
					slide.style.width = _this.slideWidth + '%';
					slide.style.visibility = 'hidden';
					slide.style.left = '-' + _this.slideWidth * index + '%';
				});
			...
			value: function initArrows() {
				var arrows = document.querySelector(this.options.arrows);
			...
			value: function showSlide(num) {
				...
				this.fadeOut(this.slides[this.currentSlide], this.options.speed, function () {
					_this2.addClass(_this2.slides[num], 'active');
					_this2.removeClass(_this2.slides[_this2.currentSlide], 'active');
					_this2.slides[_this2.currentSlide].style.opacity = 1;
					_this2.slides[_this2.currentSlide].style.visibility = 'hidden';
					_this2.currentSlide = num;
	
					_this2.sliderTimeout = setTimeout(_this2.showNext.bind(_this2), _this2.options.delay);
				});
			}
		}, {
			key: 'showNext',
			...
			key: 'fadeIn',
			value: function fadeIn(el, duration, callback) {
				var _this3 = this;
			...
			key: 'fadeOut',
			value: function fadeOut(el, duration, callback) {
				var _this4 = this;
